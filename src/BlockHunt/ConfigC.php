...
use BlockHunt\Managers\ConfigX;
...
public ConfigC
{
	...
	commandEnabled_join(Boolean.valueOf(true), W.config)
    commandEnabled_leave(Boolean.valueOf(true), W.config)
    commandEnabled_list(Boolean.valueOf(true), W.config)
    commandEnabled_shop(Boolean.valueOf(true), W.config)
    commandEnabled_start(Boolean.valueOf(true), W.config)
    commandEnabled_wand(Boolean.valueOf(true), W.config)
    commandEnabled_create(Boolean.valueOf(true), W.config)
    commandEnabled_set(Boolean.valueOf(true), W.config)
    commandEnabled_setwarp(Boolean.valueOf(true), W.config)
    commandEnabled_remove(Boolean.valueOf(true), W.config)
    commandEnabled_tokens(Boolean.valueOf(true), W.config)
    autoUpdateCheck(Boolean.valueOf(true), W.config)
    autoDownloadUpdate(Boolean.valueOf(false), W.config)
    vaultSupport(Boolean.valueOf(false), W.config)
    ...
    shop_blockChooserv1Enabled(Boolean.valueOf(true), W.config)
    shop_blockChooserv1IDname("BOOK", W.config)
    shop_blockChooserv1Price(Integer.valueOf(3000), W.config)
    ...
    shop_BlockHuntPassv2Enabled(Boolean.valueOf(true), W.config)
    shop_BlockHuntPassv2IDName("NAME_TAG", W.config)
    shop_BlockHuntPassv2Price(Integer.valueOf(150), W.config)
    ...
    scoreboard_enabled(Boolean.valueOf(true), W.config)
    ...
    requireInventoryClearOnJoin(Boolean.valueOf(false), W.config)
   ...
   private ConfigC(Object value, ConfigM config)
   {
     this.value = value;
     this.config = config;
     this.location = name().replaceAll("_", ".");
   }
 }
